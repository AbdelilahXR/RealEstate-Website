    ...
    <div className='absolute top-0 left-0 w-full z-10' >
        <div className='container mx-auto flex justify-between items-center py-4 px-4 md:px-20 lg:px-32 bg-transparent'>
            ...
            <ul className='hidden md:flex gap-7 text-white '>
              ...
              <li href="#Header" className='cursor-pointer hover:text-gray-400'>About</li>
              <li href="#Header" className='cursor-pointer hover:text-gray-400'>Project</li>
              <li href="#Header" className='cursor-pointer hover:text-gray-400'>Testimonials</li>
            </ul>
            <button className='hidden md:block bg-white px-8 py-2 rounded-full '>Sign Up</button>         
            <img onClick={()=> setshowMobileMenu(true)} src={assets.menu_icon} className='md:hidden w-7 cursor-pointer ' alt="" />
        </div> 
        {/*mobile menu */}
        <div className={`md:hidden ${showMobileMenu ? 'fixed w-full': 'w-0 h-0' }  right-0 top-0 bottom-0 overflow-hidden bg-white`}>
